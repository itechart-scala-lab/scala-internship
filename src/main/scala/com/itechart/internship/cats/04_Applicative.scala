...
object Applicative {
  ...
  /**
    ...
    * */
  trait CustomApplicative[F[_]] {
    def pure[A](x: A): Option[A]
  }

  /**
    * Ex 4.0 implement an CustomApplicative for Option
    * */
  val optionApplicative: CustomApplicative[Option] = new CustomApplicative[Option] {
