package com.itechart.internship.db

import java.sql.{Connection, DriverManager}
import java.time.Year
import java.util.UUID

import com.itechart.internship.db.DbCommon.{
  createTableAuthorsSql,
  createTableBooksSql,
  fetchHarryPotterBooksSql,
  populateDataSql,
}
import com.itechart.internship.db.DbConfig.{dbDriverName, dbPwd, dbUrl, dbUser}
