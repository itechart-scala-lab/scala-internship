...
object DataStructures {
  ...
  // Exercise 2. Calculate the total cost of all vegetables, taking vegetable amounts (in units) from
  ...
  // Exercise 4: Return a set with all subsets of the provided set `set` with `n` elements
