package com.itechart.internship.cats_effect
...
object Exercise1_Imperative {
  import com.itechart.internship.cats_effect.Exercise1_Common.response
...
object Sequence extends IOApp {
  private val tasks: List[IO[Int]] = (0 to 10).map { x =>
