package com.itechart.internship.typeclass

import com.itechart.internship.typeclass.Fp.{Jsonable, User}
import com.itechart.internship.typeclass.Summoner.Jsonable
